...
**As of**: 2026-04-17  
**Health**: AMBER  
**Top active item**: TD-002 — matrix testing (Node 18/20/22 × OS) still not migrated to active `ci.yml` (Medium severity, geordi, Sprint 2). TD-008 resolved 2026-04-17 by promotion workflow delivery.
...
| TD-008 | No `main` → `production` branch promotion workflow defined                               | High     | geordi  | 2 hrs  | 2026-04-05 | Sprint 2      | **RESOLVED 2026-04-17** |
...
| TD-R013 | No `main` → `production` branch promotion workflow (TD-008)       | 2026-04-17 | Sprint 2 | geordi      |
...
| Sprint 2 | 2           | 2              | TD-001/TD-008 resolved; TD-009/TD-010 added   | 0           |
...
- 2026-04-17: barclay — TD-008 resolved via `.github/workflows/promote-main-to-production.yml`; top active item moved to TD-002
```
