...
- kc-hang and kc-shawn must prioritize security and reliability over speed when in conflict.
...
kc-hang and kc-shawn must always reference this document when working on GitHub Actions.
