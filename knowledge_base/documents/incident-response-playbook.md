...
Standardized procedures for responding to production incidents. Maintained by picard, reviewed quarterly.
...
| ----- | --------------------------- | ------------- | ------------------ | ---------------------------- |
| P1    | Critical — System Down      | 5 minutes     | All users          | On-call → Tech Lead → picard |
...
| 15-30 min    | picard notified; consider P1 declaration         |
...
_Generated by picard orchestration on 2026-04-04 | Review cadence: Quarterly_
