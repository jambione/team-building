...
|-------|------|-------------|-----|---------|
| **P1** | Critical Bug | kc-dave → On-call Lead | 2 hours | Data loss, complete outage |
...
### Daily Triage Meeting — kc-dave Leads
...
```bash
# kc-dave performs initial triage
...
- QA team (kc-swarna, kc-kathy, kc-kalpita, kc-jairo) performs regression testing
...
---
Version History:
- 2026-04-04: kc-dave — Initial defect management process creation
---
```

---

*Created: 2026-04-04 | Owner: kc-dave (Quality Lead) | Review Cadence: Quarterly*